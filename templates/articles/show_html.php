...
<?php else : ?>
  ...
  <?php foreach ($commentaires as $commentaire) : ?>
    ...
    <a href="index?controller=comment&task=delete&id=<?= $commentaire['id'] ?>" onclick="return window.confirm(`Êtes-vous sûr de vouloir supprimer ce commentaire ?!`)" class="comment-delete">Supprimer</a>
  <?php endforeach ?>
<?php endif ?>

<form action="index?controller=comment&task=save" method="POST" class="comment-form">
